...
Class ASPTwitter
	...
	Public Function GetSearch(accountuser, sQuery, iCount, lMaxID)
		Set GetSearch = JSON.Parse(GetSearchJSON(accountuser, sQuery, iCount, lMaxID))
	End Function
...
' http://webcache.googleusercontent.com/search?q=cache:AGmabJv9g0MJ:zurb.com/forrst/posts/OAuth_Encoding_Function_in_ASP_VBScript-7ht+&cd=1&hl=en&ct=clnk&gl=uk
' oauth_encode(str)
Private Function OAuthEncode(str)
	OAuthEncode = Replace(str, "%", "%25")
	OAuthEncode = Replace(OAuthEncode, "!", "%21")
	OAuthEncode = Replace(OAuthEncode, "*", "%2A")
	OAuthEncode = Replace(OAuthEncode, "'", "%27")
	OAuthEncode = Replace(OAuthEncode, "(", "%28")
	OAuthEncode = Replace(OAuthEncode, ")", "%29")
	OAuthEncode = Replace(OAuthEncode, ";", "%3B")
	OAuthEncode = Replace(OAuthEncode, ":", "%3A")
	OAuthEncode = Replace(OAuthEncode, "@", "%40")
	OAuthEncode = Replace(OAuthEncode, "&", "%26")
	OAuthEncode = Replace(OAuthEncode, "=", "%3D")
	OAuthEncode = Replace(OAuthEncode, "+", "%2B")
	OAuthEncode = Replace(OAuthEncode, "$", "%24")
	OAuthEncode = Replace(OAuthEncode, ",", "%2C")
	OAuthEncode = Replace(OAuthEncode, "/", "%2F")
	OAuthEncode = Replace(OAuthEncode, "?", "%3F")
	OAuthEncode = Replace(OAuthEncode, "#", "%23")
	OAuthEncode = Replace(OAuthEncode, "[", "%5B")
	OAuthEncode = Replace(OAuthEncode, "]", "%5D")
	OAuthEncode = Replace(OAuthEncode, " ", "%20")
End Function
...
Private Function HeaderEncodeValue(ByVal sValues)
    ...
    sValues = OAuthEncode(sValues)
    sValues = Replace(sValues, "%" , "%25")
